...
public class TransactionThread extends Thread{
    ...
    public TransactionThread(ArrayList<Client> clients,
                             int num_of_iterations,
                             TransactionsEnum curr_transaction,
                             CountDownLatch ready,
                             CountDownLatch calling,
    ...
    public void run() {
        ...
        try {
            ...
            switch (curr_transaction) {
                case INSERT -> transaction_res = insertClientForTransaction(clients, connection);
                case SELECT -> transaction_res = selectClientForTransaction(num_of_iterations, connection);
                case UPDATE -> transaction_res = updateClientForTransaction(num_of_iterations, connection);
            }
